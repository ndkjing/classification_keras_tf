...
class garbage_classify_service(TfServingBaseService):
    def __init__(self, model_name, model_path):
        ...
        # TODO
        self.input_size = 331  # the input image size of the keras_model

       # TODO input and output key
