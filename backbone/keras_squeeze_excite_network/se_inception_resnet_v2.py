# -*- coding: utf-8 -*-
"""Se Inception-ResNet V2 weights for Keras.
...
def SEInceptionResNetV2(include_top=True,
    ...
    if K.backend() in {'cntk'}:
        raise RuntimeError('{backend} backend is currently unsupported for this weights.'.format(backend=K.backend()))
...
def get_seinceptionresnetv2(input_shape=(299, 299, 3),classes=10):
