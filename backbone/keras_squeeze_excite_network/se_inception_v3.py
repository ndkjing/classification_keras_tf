"""Squeeze and Excite Inception V3 weights
Major portions of this code is adapted from the applications folder of Keras.
Note that the input image format for this weights is different than for
...
def get_seinceptionv3(classes=10):
    model = SEInceptionV3(classes=classes)
    return model


if __name__ == '__main__':
    model = SEInceptionV3(classes=10)
    model.summary()
